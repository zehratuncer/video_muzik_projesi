...
isEmail = (email.lower().strip() == _email) #lower metindeki tüm harfleri küçük harfe çevirir
isPassword = (password.strip() == _password)#strip metnin başındaki ve sonundaki boşlukları kaldırır
